...
const BLOG = {
  ...
  SINCE: process.env.NEXT_SINCE || false, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'This is a music blog',
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email,twitter,telegram', // 分享的服務，按顺序显示,逗号隔开
